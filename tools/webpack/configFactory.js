...
if (pkg.theme && typeof(pkg.theme) === 'string') {
  ...
  // relative path
  if (cfgPath.charAt(0) === '.') {
    cfgPath = path.resolve(rootFolder, cfgPath);
    ...
    plugins: removeEmpty([
      ...
      ifProdClient(
        new webpack.LoaderOptionsPlugin({
          ...
          // minimize: true, //update by chengdi
          minimize: false,
        ...
        loaders: [{
          ...
          query: {
            ...
            plugins: removeEmpty([
             ...
             // "transform-react-inline-elements",   // 解决运行期问题，但没有Code-Splitting
      ...
      // HappyPack 'less' instance for development client.
      ifDevClient(
        happyPackPlugin({
          ...
          //   'style-loader',
          //   { path: 'css-loader', query: { sourceMap: true } },
          //   { path: 'less-loader', query: { sourceMap: true, modifyVars:JSON.stringify(theme)} },
          // ],
          loaders: [
            'style-loader',
            'css-loader?importLoaders=1&sourceMap&-autoprefixer',
    ...
    module: {
      ...
      rules: removeEmpty([
        ...
        merge(
          ...
          // For development clients we will defer all our css processing to the
          // happypack plugin named "happypack-devclient-less".
          // See the respective plugin within the plugins section for full
          // details on what loader is being implemented.
          ifDevClient({
