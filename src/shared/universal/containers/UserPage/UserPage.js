...
class UserPage extends Component {
  constructor(props, context) {
    ...
    console.log('UserPage constructor',context);
    console.log('UserPage props',props);
    console.log('UserPage this',this);
  }
  ...
  componentWillMount() {
   // console.log('UserPage componentWillMount',this.props);
    ...
    console.log('UserPage this111',this);
  }
  componentWillReceiveProps(nextProps) {
    if (this.props.params.login !== nextProps.params.login) {
      console.log('UserPage componentWillReceiveProps',this.props);
      console.log('UserPage componentWillReceiveProps:nextProps',nextProps);
  ...
  render() {
    ...
    // console.log('userpage render',this.props.userState);
    ...
    // console.log('starredRepoOwners',starredRepoOwners);
    // console.log('starredPagination',starredPagination);
    return (
      <div>
        <User user={user} />
        <hr />
