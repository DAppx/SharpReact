...
/**
 * Effect to handle authorization [worker saga]
...
/**
 * Effect to handle logging out [worker saga]
 */
 ...
 * Log in saga
 */
export function * watcherLoginFlow () {
...
/**
 * Log out saga [Watcher saga]
 * This is basically the same as the `if (winner.logout)` of above, just written
 * as a saga that is always listening to `LOGOUT` actions
 */
export function * watcherLogoutFlow () {
  while (true) {
    yield take(LOGOUT)
 ...
 */
export function * watcherRegisterFlow () {
  while (true) {
...
export function * watcherRoot () {
  yield fork(watcherLoginFlow)
  yield fork(watcherLogoutFlow)
  yield fork(watcherRegisterFlow)
}
